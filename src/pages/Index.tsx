...
const HERO_IMG =
  "https://cdn.poehali.dev/projects/67b40e03-af21-4912-82f0-ec548236011b/files/795c051d-d88c-4a34-8384-7da58a27686e.jpg";

const services = [
  {
    icon: "Zap",
    title: "Монтаж КЛ 0,4–35 кВ",
    desc: "Прокладка кабельных линий любой сложности — в земле, кабельных лотках, трубах и коллекторах.",
  },
  {
    icon: "Building2",
    title: "Электрические подстанции",
    desc: "Монтаж и наладка КТП, РУ 6–35 кВ, силовых трансформаторов и распределительных устройств.",
  },
  {
    icon: "ShieldCheck",
    title: "Проектирование",
    desc: "Разработка проектной и рабочей документации на электроснабжение объектов различного назначения.",
  },
  {
    icon: "Settings",
    title: "Пусконаладочные работы",
    desc: "Испытание и наладка электрооборудования, релейная защита и автоматика.",
  },
  {
    icon: "Wrench",
    title: "Техническое обслуживание",
    desc: "Плановое ТО и ремонт электроустановок, аварийно-восстановительные работы.",
  },
  {
    icon: "FileCheck",
    title: "Технический надзор",
    desc: "Строительный контроль на всех этапах монтажа, приёмка и сдача объектов заказчику.",
  },
];

const projects = [
  { name: "ПС 35/10 кВ «Промышленная»", vol: "35 кВ", year: "2024" },
  { name: "Электроснабжение ТЦ «Меридиан»", vol: "0,4 кВ", year: "2024" },
  { name: "КЛ 10 кВ жилого комплекса", vol: "10 кВ", year: "2023" },
  { name: "ПС 110/10 кВ «Северная»", vol: "110 кВ", year: "2023" },
  { name: "Наружное освещение трассы", vol: "0,4 кВ", year: "2022" },
  { name: "РТП завода металлоконструкций", vol: "6 кВ", year: "2022" },
];

const stats = [
  { value: "15+", label: "лет на рынке" },
  { value: "300+", label: "объектов сдано" },
  { value: "35 кВ", label: "максимальный класс напряжения" },
                ...
                <div className="bg-[#111] px-8 py-6 flex items-center justify-between group hover:bg-[#1a1a1a] transition-colors cursor-pointer border-b border-white/5">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-white/30 text-xs mt-0.5">{p.year}</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <span
          ...
          <Section>
            <div>
              ...
              <p className="text-white/60 leading-relaxed mb-4">
                Компания <span className="text-white">ЭС Электромонтаж</span> — один из ведущих
                исполнителей электромонтажных работ в регионе. С 2009 года мы реализуем объекты
                промышленного, гражданского и специального назначения.
              </p>
              <p className="text-white/60 leading-relaxed mb-8">
                В нашем арсенале — полный цикл от проектирования до пусконаладки и технического
                обслуживания электроустановок класса напряжения 0,4–35 кВ. Все работы выполняются
                в строгом соответствии с ПУЭ, ГОСТ и СП.
              </p>

              <div className="grid grid-cols-2 gap-4">
                {[
                  { icon: "Award", text: "Допуск СРО" },
            ...
            <div className="relative">
              ...
              <div className="relative bg-[#161616] p-10 border border-white/10">
                ...
                <div className="space-y-6">
                  {[
                    { label: "Монтаж кабельных линий", pct: 90 },
                    { label: "Электрические подстанции", pct: 75 },
                    { label: "Пусконаладочные работы", pct: 85 },
                    { label: "Техническое обслуживание", pct: 70 },
                  ].map((bar, i) => (
                    <div key={i}>
